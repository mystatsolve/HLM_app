...
- 무선효과 테이블: **분산/공분산** 및 **SD/상관계수** 구분 표시
...
│                         │    POST /api/analyze  │                     │
│  - Chart.js 시각화      │    GET  /api/health   │  - lme4::lmer()     │
│  - PapaParse CSV 파싱   │                       │  - lmerTest (p값)   │
│  - docx.js Word 생성    │                       │  - CORS 필터        │
│  - AI API 호출          │                       │  - JSON 직렬화      │
└───────────────────────┘                        └─────────────────────┘
         │                                                │
         │  (프론트엔드에서 직접)                          │
...
9. **무선효과 테이블 개선**: 분산/공분산/상관계수를 명확히 구분 표시
